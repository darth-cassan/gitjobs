  ...
  render() {
    ...
    return html`
      ...
      <div class="mt-2 relative">
        <div class="input-primary px-1.5 flex flex-wrap focus-within:outline focus-within:outline-[3px] focus-within:-outline-offset-2 focus-within:outline-primary-600">
          <div class="flex flex-items flex-wrap w-full">
            ${this.selected.map((option) => html`<span class="inline-flex items-center text-nowrap max-w-[100%] ps-2 pe-0.5 py-0.5 me-2 text-xs font-medium text-gray-800 bg-gray-100 rounded-full">
              <div class="flex items-center w-full">
                <div class="truncate capitalize">${this.unnormalize(option)}</div>
                <button type="button" @click=${() => this._onRemoveBadge(option)} class="inline-flex items-center p-1 ms-2 bg-transparent rounded-full hover:bg-gray-200" aria-label="Remove badge">
